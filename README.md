...
La carpeta components, views, src, helpers. Despues solo copia los siguientes archivos: App.tsx, Navegacion.js, no olvides revisar las librerias en el package.json
